...
int main(int argc , char ** argv){   //Fonction de réception des données
	...
	int mtu_value = 65520;										//Valeur modifiée par le fichier python

	set_l2cap_mtu(s , mtu_value );
	
	//Conversion du fichier initial
	data_lines initial_data;
	initial_data = DataConvert("/home/pi/Documents/Pole-Capteurs-main/server/Numerical_Results_capteur.txt");
